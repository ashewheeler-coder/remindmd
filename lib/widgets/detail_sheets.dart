...
/// Shows regimen item details with active toggle and delete. Both actions
/// reschedule/cancel the item's local notifications so the on-device queue
/// always matches the current record.
